...
import { ShoppingBag, Search, X, Menu, Globe, Camera, PlayCircle } from "lucide-react";
        ...
        <div className="col-span-6 md:col-span-2">
          ...
          <ul className="space-y-4" style={{ color: C.onSurfaceVariant }}>
            {[{ l: "Nutrition", h: "/shop" }, { l: "Apparel", h: "/category/clothing" }, { l: "Gift Sets", h: "/shop" }, { l: "The Pantry", h: "/shop" }].map(({ l, h }) => (
              <li key={l}>
                <Link href={h}>
                  <span className="font-inter text-body-md cursor-pointer transition-colors duration-200 hover:opacity-70" style={{ color: C.onSurfaceVariant }}>
                    {l}
                  </span>
                </Link>
              </li>
      ...
      >
        ...
        <div className="flex gap-8 flex-wrap">
          {[{ l: "Privacy Policy", h: "/privacy" }, { l: "Terms of Service", h: "/terms" }, { l: "Accessibility", h: "/" }].map(({ l, h }) => (
            <Link key={l} href={h}>
              <span className="font-inter text-body-md underline cursor-pointer transition-colors duration-200 hover:opacity-70" style={{ color: C.onSurfaceVariant }}>
                {l}
              </span>
            </Link>
          ))}
